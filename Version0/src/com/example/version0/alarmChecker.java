...
/**
 * MŽtodo del hilo as’ncrono, que obtiene un numero aleatorio y comprueba su paridad
 */
public void run() {
...
private void Notificar() {
	...
	{	
		...
		Notification notification = new Notification(R.drawable.ic_launcher, "Próxima Clase", System.currentTimeMillis());
	...
	if(anterioresFinales.size() != 0)
	{
		...
		//Prepara la notificacion
		Notification notification = new Notification(R.drawable.ic_launcher, "Comenta!", System.currentTimeMillis());
